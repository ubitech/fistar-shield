...
//                    wsResponses.push(b.facetResults);
        ...
        p.defaults = {aaData: null, aaSorting: [[0, "asc"]], aaSortingFixed: [], ajax: null, aLengthMenu: [10, 25, 50, 100], aoColumns: null,
            ...
            iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {oAria: {sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending"}, oPaginate: {sFirst: "Πρώτη", sLast: "Τελευταία", sNext: "Επόμενη", sPrevious: "Προηγούμενη"}, sEmptyTable: "Δεν υπάρχουν εγγραφές.", sInfo: "Βλέπετε _START_ έως _END_ από σύνολο _TOTAL_ εγγραφών", sInfoEmpty: "Βλέπετε 0 έως 0 από σύνολο 0 εγγραφών", sInfoFiltered: "(φιλτραρίστικαν από _MAX_ συνολικές εγγραφές)", sInfoPostFix: "", sDecimal: "",
                sThousands: ",", sLengthMenu: "Προβολή _MENU_ εγγραφών", sLoadingRecords: "παρακαλώ περιμένετε...", sProcessing: "παρακαλώ περιμένετε...", sSearch: "Φίλτρο:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "Δεν υπάρχουν εγγραφές που πληρούν τα κριτήρια σας"}, oSearch: g.extend({}, p.models.oSearch), sAjaxDataProp: "data", sAjaxSource: null, sDom: "lfrtip", searchDelay: null, sPaginationType: "simple_numbers", sScrollX: "", sScrollXInner: "", sScrollY: "", sServerMethod: "GET", renderer: null};
        V(p.defaults);
