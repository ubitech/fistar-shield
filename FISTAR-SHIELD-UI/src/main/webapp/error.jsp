    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-signin" method="POST" action='<%= response.encodeURL("j_security_check")%>'>
                <h2 class="form-signin-heading"><center><img src="resources/img/shield.png" width="180"/></center></h2>
                <br /><br />
                <div class="error"><center>Wrong username or password. Please try again!</center></div>
                <br /><br />
